...
public struct IntRect
{
    ...
    public IVector2 position
    {
        get
        {
            return new IVector2(this.m_XMin, this.m_YMin);
        }
        set
        {
            this.m_XMin = value.x;
    ...
    public IVector2 center
    {
        get
        {
            return new IVector2(this.x + (this.m_Width >> 1), this.y + (this.m_Height >> 1));
        }
        set
        {
    ...
    public IVector2 min
    {
        get
        {
            return new IVector2(this.xMin, this.yMin);
        }
        set
        {
            this.xMin = value.x;
    ...
    public IVector2 max
    {
        get
        {
            return new IVector2(this.xMax, this.yMax);
        }
        set
        {
            this.xMax = value.x;
    ...
    public IVector2 size
    {
        get
        {
            return new IVector2(this.m_Width, this.m_Height);
        }
        set
        {
    ...
    public bool Contains(IVector3 point, bool allowInverse)
    {
        if (!allowInverse)
        {
